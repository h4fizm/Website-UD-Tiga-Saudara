          ...
          <div class="nav">
            ...
            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('admin/article') ?>">Editor Barang</a>
                <a class="nav-link" href="<?php echo site_url('admin/article/monitor') ?>">Monitor Barang</a>
            ...
            <div class="collapse" id="collapsePage" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('admin/article/qrcode') ?>">Tambah Barang</a>
                <a class="nav-link" href="<?php echo site_url('admin/article/qrcode_edit') ?>">Edit Barang</a>
              </nav>
            </div>

            <!-- Laman Penambahan Barang -->
            ...
            <div class="collapse" id="collapsePages" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('admin/article/tambah') ?>">Form Penambahan Barang</a>
                <a class="nav-link" href="<?php echo site_url('admin/article/qrcode_generator') ?>">QR-Code Generator</a>
            ...
            <div class="collapse" id="collapseRows" aria-labelledby="headingFour" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('admin/article/laporan') ?>">Laporan Barang Berdasarkan
                  Bulan</a> 
              </nav>
            </div>
            ...
            <div class="collapse" id="collapseItems" aria-labelledby="headingFive" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('admin/article/gambar') ?>">Dokumentasi Gambar</a>
              </nav>
            </div>
          </div>
        </div>
