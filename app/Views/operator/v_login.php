                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Operator Login</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    ?>
                                    <form method="POST" action="<?php echo site_url('operator/login') ?>">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="<?php echo site_url("operator/lupapassword") ?>">Forgot
                                                Password?</a>
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small">
                                        Log in as Admin ? <a href="/admin/login">Click Here!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
