    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
          <li><a class="dropdown-item" href="<?php echo site_url('/operator/logout') ?>">Logout</a></li>
        </ul>
      </li>
    </ul>
  </nav>
          ...
          <div class="nav">
            ...
            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('operator/article') ?>">Pengurangan Barang</a>
                <a class="nav-link" href="<?php echo site_url('operator/article/monitor') ?>">Monitor Barang</a>
            ...
            <div class="collapse" id="collapseRows" aria-labelledby="headingFour" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('operator/article/laporan') ?>">Laporan Pengeluaran Hari ini</a> 
              </nav>
            </div>
            ...
            <div class="collapse" id="collapseItems" aria-labelledby="headingFive" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="<?php echo site_url('operator/article/gambar') ?>">Dokumentasi Gambar</a>
              </nav>
            </div>
          </div>
        </div>
